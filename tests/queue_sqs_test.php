    ...
    public function test_push_entry()
    {
        ...
        $sqs->client->expects($this->once())
            ...
            ->with(
                ...
                $this->callback(
                    function ($json) use ($sqs, $evententry) {
                        $this->assertEquals(
                            [
            ...
            ->willReturnCallback(
                function ($endpoint, $json, $options) use ($sqs) {
                    $sqs->client->info = [
                        'http_code' => 204,
                    ];
                }
        ...
        $sqs->client->expects($this->exactly(3))
            ...
            ->withConsecutive(
                ...
                [
                    ...
                    $this->callback(
                        function ($json) use ($sqs, $messagereceipthandle, $evententry) {
                            $this->assertEquals(
                                [
                                    'QueueUrl' => $sqs->queueurl,
            ...
            ->willReturnCallback(
                function ($endpoint, $json, $options) use ($sqs, $messagereceipthandle, $evententry) {
